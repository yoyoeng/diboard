...
__webpack_require__(/*! script.js */ "./app/javascript/script.js"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  ...
  $('#btn').click(function () {
    ...
    var addTag = $('#addTag').val(); // ②appendで動的にチェックボックスを追加

    $('.citys').append('<input type="checkbox" name="city[]" value="' + addTag + '">：' + addTag);
  });
});
...
/******/ });
//# sourceMappingURL=application-3c33e138a5854cce1c2a.js.map